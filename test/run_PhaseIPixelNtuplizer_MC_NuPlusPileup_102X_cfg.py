...
# with command line options: -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --evt_type SingleNuE10_cfi --process PrivateMC --conditions auto:phase1_2018_realistic --era Run2_2018 --geometry DB:Extended --pileup Flat_20_50 --pileup_input file:dummy.root --runUnscheduled --eventcontent RECOSIM --datatier GEN-SIM-RECO -n 10 --fileout file:TTbarMC_102X.root --python_filename test/run_PhaseIPixelNtuplizer_MC_NuPlusPileup_102X_cfg.py --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('PrivateMC',eras.Run2_2018)
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTbarMC_102X.root'),
...
print "Using options: "
if opt.globalTag == '':
    print "  globalTag (auto:phase1_2018_realistic) = "+str(process.GlobalTag.globaltag)
else:
