...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO --data --scenario pp --conditions auto:run2_data --era Run2_2017 --process RERECO --eventcontent RECO --datatier RECO --filein dummy.root --secondfilein dummy.root --python_filename=test/run_PhaseIPixelNtuplizer_Data_2017_113X_cfg.py --runUnscheduled -n 10 --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2017_cff import Run2_2017

process = cms.Process('RERECO',Run2_2017)
...
process.PhaseINtuplizerPlugin = cms.EDAnalyzer("PhaseIPixelNtuplizer",
    ...
    ALCARECO = cms.untracked.bool(False),
    )

# Switch ALCARECO collections
if opt.dataTier == 'ALCARECOTight':
    ...
    process.PhaseINtuplizerPlugin.clusterCollection = cms.InputTag("closebyPixelClusters")
    process.PhaseINtuplizerPlugin.keepAllGlobalMuons  = True
    process.PhaseINtuplizerPlugin.keepAllTrackerMuons = True
    process.PhaseINtuplizerPlugin.trackSaveDownscaleFactor = 1
    process.PhaseINtuplizerPlugin.ALCARECO = True
elif opt.dataTier == 'ALCARECO':
...
# Modify Schedule
if opt.dataTier == 'RECO' or opt.dataTier == 'FEVT' or opt.dataTier == 'ALCARECO' or opt.dataTier == 'ALCARECOTight':
